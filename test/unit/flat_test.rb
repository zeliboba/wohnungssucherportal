...
class FlatTest < ActiveRecord::TestCase

  test "square_meter_price calculation returns integer" do
    flat = Flat.new(:square_meters => 60, :price => 600)
    assert_equal 10, flat.square_meter_price
  end

  test "square_meter_price calculation returns float" do
  ...
  test "available three months" do
  ...
  test "available months is nil when flat rent has no end date" do
